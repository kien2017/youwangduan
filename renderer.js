...
var cameraselect = 0 //default qianzhi 1 wei usb shexiangtou
...
var bitpaytesturl = "https://test-insight.bitpay.com"
var bitpaybitcoinurl ="https://insight.bitpay.com"
var posttothexwebsiteurl =bitpaybitcoinurl
...
posttothexwebsiteurl = bitpaybitcoinurl
  
}else if(selectnet == "testnet"){

network = Networks.testnet
posttothexwebsiteurl =bitpaytesturl
...
$("#btngetunsigndata").click(function(){
 ...
 $('table').hide()
  ...
  var fee =Decimal($("#sendfee").val() || 0.001 ) //zhe li keyi gaijing
...
function openCamera(){
  Instascan.Camera.getCameras().then(function (cameras) {
    if (cameras.length > 0) {
      scanner.start(cameras[cameraselect]); // 0 wei qianzhi she xiang tou , 1 wei usb she xiang tou
    } else {
...
$.post(posttothexwebsiteurl+"/api/tx/send", { rawtx: hextosend})
  .done(function( data ) {
    ...
    $("ul").append("<li><p>broadcast ok!    url :" + posttothexwebsiteurl+"/tx/"+data['txid']+"</p></li>")
  });
